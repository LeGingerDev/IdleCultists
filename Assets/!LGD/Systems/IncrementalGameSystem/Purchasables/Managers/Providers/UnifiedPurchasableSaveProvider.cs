...
/// <summary>
/// Unified save provider for all purchasables (both StatPurchasables and EventPurchasables)
/// Replaces both UpgradeSaveProvider and PurchasableSaveProvider
/// </summary>
public class UnifiedPurchasableSaveProvider : SaveLoadProviderBase<BasePurchasableRuntimeData>
{
    protected override string GetSaveFileName()
    {
        return "unified_purchasables.json";
    }
    ...
    protected override IEnumerator CreateDefault()
    {
        ...
        {
            DebugManager.Error("[IncrementalGame] UnifiedPurchasableRegistry not found! Cannot create default purchasable data");
        }
    ...
    public IEnumerator SyncWithRegistry()
    {
        ...
        {
            DebugManager.Error("[IncrementalGame] UnifiedPurchasableRegistry not found! Cannot sync with registry");
        }
