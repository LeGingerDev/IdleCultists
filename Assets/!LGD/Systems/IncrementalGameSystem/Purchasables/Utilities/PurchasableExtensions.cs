...
/// <summary>
/// Extension methods for all purchasables (both StatPurchasables and EventPurchasables)
...
public static class PurchasableExtensions
{
    ...
    public static int GetPurchaseCount(this string purchasableId)
    {
        ...
        return PurchasableManager.Instance != null
            ? PurchasableManager.Instance.GetPurchaseCount(purchasableId)
            : 0;
    }
    ...
    public static BasePurchasable GetBlueprint(this BasePurchasableRuntimeData runtimeData)
    {
        ...
        PurchasableRegistry registry = RegistryManager.Instance.GetRegistry<BasePurchasable>() as PurchasableRegistry;
