...
public class LifeCrystalUpgradeDisplay : BaseBehaviour
{
    ...
    {
        if (_upgradeBlueprint.icon != null)
        {
            _displayIcon.sprite = _upgradeBlueprint.icon;
        }
    ...
    private void OnDisplayClicked()
    {
        ...
        Publish(LifeCrystalEventIds.ON_UPGRADE_SELECTED, _upgradeBlueprint);
    }
    ...
    private void FadeIn()
    {
        ...
        Debug.Log($"<color=green>[LifeCrystal] Revealed upgrade:</color> {_upgradeBlueprint.displayName}");
    }
    ...
    private bool ArePrerequisitesMet()
    {
        ...
        return _upgradeBlueprint.ArePrerequisitesMet();
    }

    public UpgradeBlueprint GetBlueprint()
    {
        return _upgradeBlueprint;
    }
    ...
    {
        if (blueprint != _upgradeBlueprint)
        {
            SetSelected(false);
        }
        else
    ...
    {
        // Deselect when purchasable is selected
        SetSelected(false);
    }
