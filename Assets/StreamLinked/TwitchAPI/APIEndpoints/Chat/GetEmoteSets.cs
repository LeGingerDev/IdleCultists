...
namespace ScoredProductions.StreamLinked.API.Chat {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/api/reference/#get-emote-sets">Twitch API Class</see>
	/// </summary>
	[Serializable]
	public struct GetEmoteSets : IChat {
		...
		public readonly string Endpoint => TwitchAPILinks.GetEmoteSets;
		public readonly TwitchAPIClassEnum TypeEnum => TwitchAPIClassEnum.GetEmoteSets;
