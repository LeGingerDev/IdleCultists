...
namespace ScoredProductions.StreamLinked.API.Extensions {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/api/reference/#get-extensions">Twitch API Class</see>
	/// </summary>
	[Serializable]
	public struct GetExtensions : IExtensions {
		...
		public readonly TwitchAPIClassEnum TypeEnum => TwitchAPIClassEnum.GetExtensions;
