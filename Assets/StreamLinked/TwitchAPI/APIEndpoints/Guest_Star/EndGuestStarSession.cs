...
namespace ScoredProductions.StreamLinked.API.Guest_Star {
	/// <summary>
	/// <c>BETA</c>
	/// <see href="https://dev.twitch.tv/docs/api/reference/#end-guest-star-session">Twitch API Class</see>
	/// </summary>
	[Serializable]
	public struct EndGuestStarSession : IGuest_Star {
		...
		public readonly TwitchAPIClassEnum TypeEnum => TwitchAPIClassEnum.EndGuestStarSession;
