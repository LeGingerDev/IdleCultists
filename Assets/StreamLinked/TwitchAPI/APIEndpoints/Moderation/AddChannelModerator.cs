...
namespace ScoredProductions.StreamLinked.API.Moderation {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/api/reference/#add-channel-moderator">Twitch API Class</see>
	/// </summary>
	[Serializable]
	public struct AddChannelModerator : IModeration, INoResponse {
		...
		public readonly TwitchAPIClassEnum TypeEnum => TwitchAPIClassEnum.AddChannelModerator;
