...
namespace ScoredProductions.StreamLinked.API.Moderation {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/api/reference/#get-unban-requests">Twitch API Class</see>
	/// </summary>
	[Serializable]
	public struct GetUnbanRequests : IModeration {
		...
		public readonly TwitchAPIClassEnum TypeEnum => TwitchAPIClassEnum.GetUnbanRequests;
