...
namespace ScoredProductions.StreamLinked.API.Moderation {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/api/reference/#get-vips">Twitch API Class</see>
	/// </summary>
	[Serializable]
	public struct GetVIPs : IModeration {
		...
		public readonly TwitchAPIClassEnum TypeEnum => TwitchAPIClassEnum.GetVIPs;
