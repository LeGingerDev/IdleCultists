...
namespace ScoredProductions.StreamLinked.API.Moderation {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/api/reference/#remove-channel-vip">Twitch API Class</see>
	/// </summary>
	[Serializable]
	public struct RemoveChannelVIP : IModeration, INoResponse {
		...
		public readonly TwitchAPIClassEnum TypeEnum => TwitchAPIClassEnum.RemoveChannelVIP;
