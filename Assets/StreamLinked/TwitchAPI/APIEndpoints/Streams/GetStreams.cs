...
namespace ScoredProductions.StreamLinked.API.Streams {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/api/reference/#get-streams">Twitch API Class</see>
	/// </summary>
	[Serializable]
	public struct GetStreams : IStreams {
...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		public readonly string Endpoint => TwitchAPILinks.GetStreams;
		public readonly TwitchAPIClassEnum TypeEnum => TwitchAPIClassEnum.GetStreams;
		public readonly TwitchScopesEnum[] Scopes => Array.Empty<TwitchScopesEnum>();

		public static string USER_ID => TwitchWords.USER_ID;
		public static string USER_LOGIN => TwitchWords.USER_LOGIN;
