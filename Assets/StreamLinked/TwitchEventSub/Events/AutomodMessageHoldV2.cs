...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#autoMessagehold-v2">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct AutoMessageHoldV2 : IChannel {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Automod_Message_Hold_V2;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.moderator_manage_automod,
		};

		public AutoMessageHoldV2(JsonValue body) {
