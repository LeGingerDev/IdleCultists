...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelcharity_campaignprogress">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelCharityCampaignProgress : ICharityCampaign {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Charity_Campaign_Progress;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.channel_read_charity,
		};

		public ChannelCharityCampaignProgress(JsonValue body) {
