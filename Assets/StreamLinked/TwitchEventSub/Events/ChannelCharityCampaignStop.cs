...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelcharity_campaignstop">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelCharityCampaignStop : ICharityCampaign {
		...
		[field: SerializeField] public string stopped_at { get; set; }

		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Charity_Campaign_Stop;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.channel_read_charity,
		};

		public ChannelCharityCampaignStop(JsonValue body) {
			...
			this.stopped_at = body[TwitchWords.STOPPED_AT].AsString;
		}
	}
}