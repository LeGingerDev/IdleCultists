...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelgoalbegin">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelGoalsBegin : IGoals {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Goal_Begin;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.channel_read_goals,
		};

		public ChannelGoalsBegin(JsonValue body) {
