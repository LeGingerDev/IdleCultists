...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelguest_star_sessionbegin">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelGuestStarSessionBegin : IChannel {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Guest_Star_Session_Begin;
		...
		public ChannelGuestStarSessionBegin(JsonValue body) {
