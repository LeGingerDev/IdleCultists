...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	...
	/// </summary>
	[Serializable]
	public struct ChannelModerate : IChannel {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Moderate;
		...
		public ChannelModerate(JsonValue body) {
