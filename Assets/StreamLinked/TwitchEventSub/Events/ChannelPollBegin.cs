...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelpollbegin">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelPollBegin : IPoll {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Poll_Begin;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.channel_read_polls,
			TwitchScopesEnum.channel_manage_polls,
		};

		public ChannelPollBegin(JsonValue body) {
