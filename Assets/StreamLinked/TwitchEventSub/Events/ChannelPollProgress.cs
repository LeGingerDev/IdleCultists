...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelpollprogress">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelPollProgress : IPoll {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Poll_Progress;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.channel_read_polls,
			TwitchScopesEnum.channel_manage_polls,
		};

		public ChannelPollProgress(JsonValue body) {
