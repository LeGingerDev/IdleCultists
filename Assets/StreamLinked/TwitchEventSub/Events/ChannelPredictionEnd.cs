...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelpredictionend">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelPredictionEnd : IPrediction {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Prediction_End;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.channel_read_predictions,
			TwitchScopesEnum.channel_manage_predictions,
		};

		public ChannelPredictionEnd(JsonValue body) {
