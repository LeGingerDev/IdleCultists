...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelpredictionprogress">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelPredictionProgress : IPrediction {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Prediction_Progress;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.channel_read_predictions,
			TwitchScopesEnum.channel_manage_predictions,
		};

		public ChannelPredictionProgress(JsonValue body) {
