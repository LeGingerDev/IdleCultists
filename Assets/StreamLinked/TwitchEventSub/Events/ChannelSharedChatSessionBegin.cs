...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-reference/#channel-shared-chat-session-begin-event">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelSharedChatSessionBegin  : IChannel {
		...
		[field: SerializeField] public Participant[] participants { get; set; }

		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Shared_Chat_Session_Begin;
		public readonly TwitchScopesEnum[] Scopes => Array.Empty<TwitchScopesEnum>();

		public ChannelSharedChatSessionBegin(JsonValue body) {
			...
			this.participants = body[TwitchWords.PARTICIPANTS].AsJsonArray.ToModelArray<Participant>();
		}
	}
}