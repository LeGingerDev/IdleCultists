...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	...
	/// </summary>
	[Serializable]
	public struct ChannelSharedChatSessionUpdate : IChannel {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Shared_Chat_Session_Update;
		public readonly TwitchScopesEnum[] Scopes => Array.Empty<TwitchScopesEnum>();

		public ChannelSharedChatSessionUpdate(JsonValue body) {
