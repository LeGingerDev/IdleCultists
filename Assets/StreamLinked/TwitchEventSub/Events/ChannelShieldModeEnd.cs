...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelshield_modeend">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelShieldModeEnd : IShield {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Shield_Mode_End;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.moderator_read_shield_mode,
			TwitchScopesEnum.moderator_manage_shield_mode,
		};

		public ChannelShieldModeEnd(JsonValue body) {
