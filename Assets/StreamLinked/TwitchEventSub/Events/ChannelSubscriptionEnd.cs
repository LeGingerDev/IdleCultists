...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelsubscriptionend">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelSubscriptionEnd : ISubscription {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Subscription_End;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.channel_read_subscriptions,
		};

		public ChannelSubscriptionEnd(JsonValue body) {
