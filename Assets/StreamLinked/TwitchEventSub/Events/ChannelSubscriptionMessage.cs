...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelsubscriptionmessage">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelSubscriptionMessage : ISubscription {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Subscription_Message;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.channel_read_subscriptions,
		};

		public ChannelSubscriptionMessage(JsonValue body) {
