...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelunban_requestresolve">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelUnbanRequestResolve : IChannel {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Unban_Request_Resolve;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.moderator_read_unban_requests,
			TwitchScopesEnum.moderator_manage_unban_requests,
		};

		public ChannelUnbanRequestResolve(JsonValue body) {
