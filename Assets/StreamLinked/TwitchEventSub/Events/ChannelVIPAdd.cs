...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelvipadd">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelVIPAdd : IChannel {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_VIP_Add;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.channel_read_vips,
			TwitchScopesEnum.channel_manage_vips,
		};

		public ChannelVIPAdd(JsonValue body) {
