...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelwarningacknowledge">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelWarningAcknowledge : IChannel {
		...
		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Warning_Acknowledge;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.moderator_read_warnings,
			TwitchScopesEnum.moderator_manage_warnings,
		};

		public ChannelWarningAcknowledge(JsonValue body) {
