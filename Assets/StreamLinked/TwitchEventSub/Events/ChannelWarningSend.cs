...
namespace ScoredProductions.StreamLinked.EventSub.Events {
	/// <summary>
	/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelwarningsend">Twitch Eventsub Reference</see>
	/// </summary>
	[Serializable]
	public struct ChannelWarningSend : IChannel {
		...
		[field: SerializeField] public string[] chat_rules_cited { get; set; }

		public readonly TwitchEventSubSubscriptionsEnum Enum => TwitchEventSubSubscriptionsEnum.Channel_Warning_Send;
		public readonly TwitchScopesEnum[] Scopes => new TwitchScopesEnum[] {
			TwitchScopesEnum.moderator_read_warnings,
			TwitchScopesEnum.moderator_manage_warnings,
		};

		public ChannelWarningSend(JsonValue body) {
			...
			this.chat_rules_cited = body[TwitchWords.CHAT_RULES_CITED].AsJsonArray?.CastToStringArray;
		}
	}
}